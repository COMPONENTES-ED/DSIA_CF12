    ...
    .row.justify-content-center.align-items-center.mb-5
        ...
        .col-sm-12.col-lg-9
          .tarjeta.bg-color-5.p-4
            p.mb-3 Las curvas ROC (#[em Receiver Operating Characteristic]) son una representación gráfica que permite evaluar el rendimiento de un modelo de clasificación binaria a diferentes umbrales de discriminación. En el eje vertical se representa la tasa de verdaderos positivos (sensibilidad) y en el eje horizontal la tasa de falsos positivos (1 - especificidad). Al trazar la curva ROC, podemos observar cómo varía el desempeño del modelo al modificar el umbral de decisión.
